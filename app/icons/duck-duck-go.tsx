...
export const DuckDuckGo = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <g transform="matrix(.26667 0 0 .26667 -17.955 -5.057)">
      ...
      <g clipPath="url(#b)">
        ...
        />
        <path
          d="M109.02 70.69a3.785 3.785 0 0 1 3.79-3.787c2.1 0 3.785 1.694 3.785 3.787s-1.695 3.786-3.785 3.786a3.784 3.784 0 0 1-3.79-3.786z"
          fill="#2d4f8e"
        />
        <path
          d="M113.507 69.43a.98.98 0 0 1 .98-.983.982.982 0 1 1-.98.983z"
          fill="#fff"
        />
        <path
          d="M134.867 68.445a3.255 3.255 0 1 1 3.252 3.258 3.26 3.26 0 0 1-3.252-3.258z"
          fill="#2d4f8e"
        />
        <path
